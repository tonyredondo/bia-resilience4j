...
class HedgeConfigTest {
    ...
    private static final String HEDGE_TO_STRING = "HedgeConfig{shouldUseFactorAsPercentage=false, hedgeTimeFactor=0, shouldMeasureErrors=true, windowSize=100, cutoff=null}";
